class Solution:
    ...
    def isAnagram(self, s: str, t: str) -> bool:
        ...
        # THIS LOOP IS SLOWING DOWN THE WHOLE SOLUTION!!!! ----v (still O(n) )
        ...
        for i in range(len(seen)): 
            #print(seen[s[i]])
            if seen[s[i]] > 0 or seen[s[i]] < 0: # this wastes time, but im not sure
                                                 # how to use dict to speed it up - still O(n) !
                return False
